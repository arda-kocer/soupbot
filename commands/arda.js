...
module.exports = {
	...
	execute(message, args) {
        ...
        var audios = ["./arda/cheats.mp3","./arda/confidentthrow.mp3","./arda/desgibtsnicht.mp3","./arda/duhuanson.mp3","./arda/dunuttensohn.mp3","./arda/packsnicht.mp3","./arda/warnieweg.mp3",
                    "./arda/schwanz.mp3","./arda/amerika.mp3","./arda/junge.mp3","./arda/nurweilichclippe.mp3","./arda/wohin.mp3",'./arda/klassischerkanacke.mp3','./arda/soschlechtwiedu.mp3'];
